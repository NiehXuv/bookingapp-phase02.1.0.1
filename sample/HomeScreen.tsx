...
import { Search, Hotel, Plane, Compass, Wand2 } from "lucide-react";
        ...
        <div className="bg-white/50 rounded-[20px] p-[10px] mb-6 shadow-lg backdrop-blur-[5px] border border-white/60">
          ...
          <div className="flex gap-[10px]">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-[10px] h-[40px] rounded-[30px] bg-travel-primary text-white"
            >
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-[10px] h-[40px] rounded-[30px] border border-travel-chip-border bg-white/50 backdrop-blur-[5px] text-travel-icons"
            >
